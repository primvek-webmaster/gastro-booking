    angular.module('app').directive('angularRatingIcons', function () {
        return {
            replace: true,
            require: 'ngModel',
            scope: {
            ...
            link: function (scope, element, attrs, controller) {
                ...
                scope.value = (controller.$viewValue * 2) || (+attrs.defaultValue || 0);
                ...
                controller.$render = function () {
                    scope.value = controller.$viewValue === 0 ? 0 : (controller.$viewValue * 2) || scope.value;

                    // update model safeguard/fallback should it not be initialized before
                    controller.$setViewValue(scope.value / 2);
                };
