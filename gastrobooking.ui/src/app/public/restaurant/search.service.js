...
(function () {
    ...
    function SearchService($rootScope, $state, TokenRestangular, moment) {
        ...
        function searchRecommended(search, currentPage){
            return TokenRestangular.all('restaurantRecommended?search=' + search.restaurantSearchKeyword + '&page=' + currentPage).customPOST(search);
        }
