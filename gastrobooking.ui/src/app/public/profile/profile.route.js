    ...
    function moduleConfig($stateProvider) {
        ...
        $stateProvider
            .state('main.profile', {
                ...
                controllerAs: 'vm'
            }).state('main.restaurantRequest', {
                url: "/restaurant/{restaurantId}/request",
                templateUrl: "app/public/profile/restaurant_request.html",
                controller: 'RestaurantRequestController',
                controllerAs: 'vm'
            }).state('main.editor', {
                url: "/editor",
