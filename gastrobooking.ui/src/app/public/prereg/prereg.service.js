...
(function () {
    ...
    function PreregService(TokenRestangular, $translate) {
        ...
        function updateStatus(params) {
            return TokenRestangular.all('prereg/updateStatus').customPOST(params);
        }
        function changeRestaurant(params) {
            return TokenRestangular.all('prereg/changeRestaurant').customPOST(params);
        }
        function sendEmailConfirmation(params) {
            return TokenRestangular.all('prereg/send-confirmation').customPOST(params);
        }
