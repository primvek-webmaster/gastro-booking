...
<head>
	...
	* {
	...
	<?php foreach($styles as $param => $data): ?>
	<?php list($el, $prop, $default) = $data ?>

	<?php echo e($el); ?> {
		<?php echo e($prop); ?>: <?php echo e(Request::get($param, $default)); ?>;
	}
	<?php endforeach; ?>
	</style>
</head>
...
<div class="container-fluid">
	<?php foreach($items as $item): ?>
		<div class="row item">
			<div class="col-md-1">
				<img src="http://api.gastro-booking.cz/uploads/items/<?php echo e($item->photo); ?>" class="image" />
			</div>
			...
			<div class="col-md-1">
				<h4 class="title"><?php echo e($item->preifx); ?></h4>
			</div>
			
			<div class="col-md-2">
				<h3 class="price"><?php echo e(round($item->price)); ?> <?php echo e($item->currency); ?></h3>
			</div>
