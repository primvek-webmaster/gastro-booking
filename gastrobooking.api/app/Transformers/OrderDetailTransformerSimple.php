...
class OrderDetailTransformerSimple extends TransformerAbstract
{
            ...
            if ($restaurant){
                ...
                $res = array_merge(
                    ...
                    [
                        ...
                        "businesss_latitude" => $orderDetail->client->latitude,
                        "businesss_longitude" => $orderDetail->client->longitude,
