...
class Restaurant extends Model
{
    ...
    public function requests(){
        return $this->hasMany(MealRequest::class, 'ID_restaurant');
    }

    public function confirmed_requests(){
        return $this->requests()->where("status",'A');
    }
    ...
    public function scopeFilterByHighlight($query, Request $request){
        return $query->where("highlight", '>', 0);
    }
}
