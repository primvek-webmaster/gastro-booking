...
class WebWidgetController extends Controller
{
    ...
    public function css(Request $request) {
        $selectors = [
            ...
            'showphoto' => ['.widget__showphoto ',['off' => ['display' => 'none'], 'on' => ['display' => 'inline-block']]],
            ...
            'menudirection' => ['.widget__menu',['right'=>['float'=>'right'],'up'=>[],'left'=>['float'=>'left']]] //position of the menu
